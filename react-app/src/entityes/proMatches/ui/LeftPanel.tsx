        ...
        <>
            <aside className="sticky top-6 h-fit w-64 shrink-0 rounded-lg border border-gray-900 bg-gray-900 p-4">
                ...
                <div className="flex flex-col gap-2">
                    <div>
                        <button className={`${sortType === "NEWEST" ? "border-red-500 text-red-500" : "" }
                    ...
                    <div>
                        <button className={`${sortType === "OLDEST" ? "border-red-500 text-red-500" : "" }
                        rounded-md border w-full px-3 py-2 text-left text-xs transition-all duration-150 hover:cursor-pointer`}
                    ...
                    <div>
                        <button className={`${sortType === "LONGEST" ? "border-red-500 text-red-500" : "" }
                        rounded-md border w-full px-3 py-2 text-left text-xs transition-all duration-150 hover:cursor-pointer`}
                    ...
                    <div>
                        <button className={`${sortType === "SHORTEST" ? "border-red-500 text-red-500" : "" }
                        rounded-md border w-full px-3 py-2 text-left text-xs transition-all duration-150 hover:cursor-pointer`}
